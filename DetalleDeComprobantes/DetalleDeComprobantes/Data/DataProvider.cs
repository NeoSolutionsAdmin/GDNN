...
namespace Christoc.Modules.DetalleDeComprobantes.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.DetalleDeComprobantes.Data.SqlDataprovider,DetalleDeComprobantes";

  ...
  <div >
    ...
    <div>
        ...
        <div class="SubMenu2">
            ...
            <br />
            <span class="FormLabel">Clave del vendedor:</span><asp:TextBox ClientIDMode="Static" runat="server" ID="txt_PasswordVendedor"></asp:TextBox>
            <asp:Button Text="Establecer Contraseña" ID="btn_EstablecerContraseña" runat="server" CssClass="FormButton FirstElement LastElement" OnClientClick="UpdatePassword();return false;" />
...
<script>
    ...
    {
        var txtPassword = $("#txt_PasswordVendedor").val();
        var hostn = $("#hostn").val();
        var IdVendedor = $("#cmb_ListadoVendedores option:selected").val();
        window.location.href = hostn + "MyManager/Configuracion?UpdatePassword=" + txtPassword + "&IDV=" + IdVendedor;
        return false;
    }

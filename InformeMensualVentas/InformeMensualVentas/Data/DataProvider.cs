...
namespace Christoc.Modules.InformeMensualVentas.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.InformeMensualVentas.Data.SqlDataprovider,InformeMensualVentas";

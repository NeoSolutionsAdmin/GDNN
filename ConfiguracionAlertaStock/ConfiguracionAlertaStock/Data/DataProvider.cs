...
namespace Christoc.Modules.ConfiguracionAlertaStock.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.ConfiguracionAlertaStock.Data.SqlDataprovider,ConfiguracionAlertaStock";

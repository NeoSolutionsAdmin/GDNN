...
namespace Christoc.Modules.AlertaStockHideModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.AlertaStockHideModule.Data.SqlDataprovider,AlertaStockHideModule";

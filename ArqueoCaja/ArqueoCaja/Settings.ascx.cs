...
namespace Christoc.Modules.ArqueoCaja
{
    ...
    /// 
    /// Because the control inherits from ArqueoCajaSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : ArqueoCajaModuleSettingsBase
    {

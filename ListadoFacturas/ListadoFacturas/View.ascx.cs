...
namespace Christoc.Modules.ListadoFacturas
{
    ...
    public partial class View : ListadoFacturasModuleBase, IActionable
    {
        ...
        public string sessionkey = "SearchFacturas";
        public string sessionkeypagos = "SearchPagos";
        public string sessionkeyretiros = "SearchRetiros";
        ...
        void BuildStatics()
        {
         /*   List<Struct_DetalleFactura> MyProds = new List<Struct_DetalleFactura>();
            ...
            {
                List<Data2.Class.Struct_Factura> _LF = Session[sessionkey] as List<Data2.Class.Struct_Factura>;
                List<Data2.Class.Struct_Factura> _LFNoRemitos = new List<Data2.Class.Struct_Factura>();
                foreach (Data2.Class.Struct_Factura MF in _LF)
                {
                    if (MF.IsRemito == false && MF.FacturaTipo!=Struct_Factura.TipoDeFactura.Presupuesto)
                    {
                        _LFNoRemitos.Add(MF);
                    }
                }
